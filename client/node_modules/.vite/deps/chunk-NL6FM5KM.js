...
// ../node_modules/.bun/better-auth@1.4.10+2d8ddc2d470fbe56/node_modules/better-auth/dist/adapters/kysely-adapter/dialect.mjs
...
var createKyselyAdapter = async (config) => {
  ...
  if ("fileControl" in db) {
    const { BunSqliteDialect } = await import("./bun-sqlite-dialect-JVPT2FRM.js");
  ...
  if ("createSession" in db && typeof window === "undefined") {
    ...
    if (DatabaseSync && db instanceof DatabaseSync) {
      const { NodeSqliteDialect } = await import("./node-sqlite-dialect-F7OKIP3F.js");
...
//# sourceMappingURL=chunk-NL6FM5KM.js.map
